...
function findNearestBoundary(matches, routeId) {
  ...
  return eligibleMatches.reverse().find(
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator } = React4.useContext(NavigationContext);
...
function useNavigate() {
  let { isDataRoute } = React4.useContext(RouteContext);
...
function useNavigateUnstable() {
  ...
  let { basename, navigator } = React4.useContext(NavigationContext);
  let { matches } = React4.useContext(RouteContext);
  ...
  let navigate = React4.useCallback(
    (to, options = {}) => {
...
function useOutlet(context) {
  ...
  return React4.useMemo(
    () => outlet && /* @__PURE__ */ React4.createElement(OutletContext.Provider, { value: context }, outlet),
    [outlet, context]
  );
}
function useParams() {
...
function useRoutesImpl(routes, locationArg, dataRouterOpts) {
  ...
  let { navigator } = React4.useContext(NavigationContext);
  let { matches: parentMatches } = React4.useContext(RouteContext);
...
function DefaultErrorComponent() {
  ...
  if (ENABLE_DEV_WARNINGS) {
    ...
    devInfo = /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("p", null, "\u{1F4BF} Hey developer \u{1F44B}"), /* @__PURE__ */ React4.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /* @__PURE__ */ React4.createElement("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", /* @__PURE__ */ React4.createElement("code", { style: codeStyles }, "errorElement"), " prop on your route."));
  }
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("h2", null, "Unexpected Application Error!"), /* @__PURE__ */ React4.createElement("h3", { style: { fontStyle: "italic" } }, message), stack ? /* @__PURE__ */ React4.createElement("pre", { style: preStyles }, stack) : null, devInfo);
}
...
var RenderErrorBoundary = class extends React4.Component {
  ...
  render() {
    ...
    let result = error !== void 0 ? /* @__PURE__ */ React4.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ React4.createElement(
    ...
    if (this.context) {
      return /* @__PURE__ */ React4.createElement(RSCErrorHandler, { error }, result);
    }
    return result;
  }
};
...
function RSCErrorHandler({
  ...
  let { basename } = React4.useContext(NavigationContext);
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return /* @__PURE__ */ React4.createElement(RouteContext.Provider, { value: routeContext }, children);
}
function _renderMatches(matches, parentMatches = [], dataRouterOpts) {
  ...
  return renderedMatches.reduceRight(
    (outlet, match, index) => {
      ...
      return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? /* @__PURE__ */ React4.createElement(
        RenderErrorBoundary,
        {
          location: dataRouterState.location,
...
function useRevalidator() {
  ...
  let revalidate = React4.useCallback(async () => {
...
function useAsyncValue() {
  let value = React4.useContext(AwaitContext);
  return value?._data;
}
...
function useBlocker(shouldBlock) {
  ...
  let [blockerKey, setBlockerKey] = React4.useState("");
  let blockerFunction = React4.useCallback(
    (arg) => {
...
function RouterProvider({
  ...
  let [_state, setStateImpl] = React10.useState(router.state);
  let [state, setOptimisticState] = useOptimistic(_state);
  let [pendingState, setPendingState] = React10.useState();
  let [vtContext, setVtContext] = React10.useState({
    isTransitioning: false
  });
  let [renderDfd, setRenderDfd] = React10.useState();
  let [transition, setTransition] = React10.useState();
  let [interruption, setInterruption] = React10.useState();
  let fetcherData = React10.useRef(/* @__PURE__ */ new Map());
  ...
  React10.useLayoutEffect(() => router.subscribe(setState), [router, setState]);
  React10.useEffect(() => {
  ...
  let dataRouterContext = React10.useMemo(
    () => ({
      router,
      navigator,
      static: false,
  ...
  return /* @__PURE__ */ React10.createElement(React10.Fragment, null, /* @__PURE__ */ React10.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React10.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React10.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ React10.createElement(ViewTransitionContext.Provider, { value: vtContext }, /* @__PURE__ */ React10.createElement(
    Router,
    {
      basename,
      location: state.location,
...
var MemoizedDataRoutes = React10.memo(DataRoutes2);
...
function MemoryRouter({
  ...
  let historyRef = React10.useRef(null);
...
function Navigate({
  ...
  let { static: isStatic } = React10.useContext(NavigationContext);
  warning(
    !isStatic,
    `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`
  );
  let { matches } = React10.useContext(RouteContext);
  let { pathname: locationPathname } = useLocation();
...
function Router({
  ...
  let navigationContext = React10.useMemo(
    () => ({
      basename,
      navigator,
      static: staticProp,
  ...
  let locationContext = React10.useMemo(() => {
  ...
  return /* @__PURE__ */ React10.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ React10.createElement(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location
...
function Await({
  ...
  let dataRouterContext = React10.useContext(DataRouterContext);
  let dataRouterStateContext = React10.useContext(DataRouterStateContext);
  let onError = React10.useCallback(
    (error, errorInfo) => {
  ...
  return /* @__PURE__ */ React10.createElement(
    ...
    /* @__PURE__ */ React10.createElement(ResolveAwait, null, children)
  );
}
var AwaitErrorBoundary = class extends React10.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2 /* error */) {
      return /* @__PURE__ */ React10.createElement(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1 /* success */) {
      return /* @__PURE__ */ React10.createElement(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
function ResolveAwait({
  ...
  return /* @__PURE__ */ React10.createElement(React10.Fragment, null, toRender);
}
function createRoutesFromChildren(children, parentPath = []) {
  let routes = [];
  React10.Children.forEach(children, (element, index) => {
    if (!React10.isValidElement(element)) {
      return;
    }
    let treePath = [...parentPath, index];
    if (element.type === React10.Fragment) {
      routes.push.apply(
        routes,
...
function WithComponentProps({
  ...
  return React10.cloneElement(children, props);
}
function withComponentProps(Component4) {
  return function WithComponentProps2() {
    const props = useRouteComponentProps();
    return React10.createElement(Component4, props);
  };
}
...
function withHydrateFallbackProps(HydrateFallback) {
  return function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
    return React10.createElement(HydrateFallback, props);
  };
}
...
function withErrorBoundaryProps(ErrorBoundary) {
  return function WithErrorBoundaryProps2() {
    const props = useErrorBoundaryProps();
    return React10.createElement(ErrorBoundary, props);
  };
}
