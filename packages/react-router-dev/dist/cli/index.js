 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-D9G1j4ne.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-Bk7D8pR2.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-C6J-GBOh.js");
	if (options.profile) await start();
